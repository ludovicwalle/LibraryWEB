...
public abstract class CustomizedServlet extends HttpServlet {
	...
	/**
	 * Cette méthode est une alternative à {@link #doDelete(HttpServletRequest, HttpServletResponse)} mais avec un premier paramètre de type {@link CustomizedRequest} au lieu de
	 * {@link HttpServletRequest}. Ce type de paramètre simplifie la récupération de fichier et la manipulation des paramètres.<br>
	...
	/**
	 * Cette méthode est une alternative à {@link #doGet(HttpServletRequest, HttpServletResponse)} mais avec un premier paramètre de type {@link CustomizedRequest} au lieu de
	 * {@link HttpServletRequest}. Ce type de paramètre simplifie la récupération de fichier et la manipulation des paramètres.<br>
	...
	/**
	 * Cette méthode est une alternative à {@link #doPost(HttpServletRequest, HttpServletResponse)} mais avec un premier paramètre de type {@link CustomizedRequest} au lieu de
	 * {@link HttpServletRequest}. Ce type de paramètre simplifie la récupération de fichier et la manipulation des paramètres.<br>
	...
	/**
	 * Cette méthode est une alternative à {@link #doPut(HttpServletRequest, HttpServletResponse)} mais avec un premier paramètre de type {@link CustomizedRequest} au lieu de
	 * {@link HttpServletRequest}. Ce type de paramètre simplifie la récupération de fichier et la manipulation des paramètres.<br>
